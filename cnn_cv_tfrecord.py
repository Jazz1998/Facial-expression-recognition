...
default_width = 48
batch_size = 100  # 批尺寸，内存小就调小些
test_batch_size = 100  # 测试时的批尺寸，内存小就调小些
shuffle_pool_size = 2000 # 内存小就调小些
generations = 15000  # 总迭代数
...
def main(argv):
    with tf.Session() as sess:
        ...
        plt.plot(temp_test_loss, 'r')
        plt.subplot(2, 1, 2)
        plt.ylabel('Test Accuracy')
        plt.plot(temp_test_acc, 'r')
